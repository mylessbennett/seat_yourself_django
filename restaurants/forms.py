...
class ReservationForm(ModelForm):
    ...
    def clean_time(self):
        ...
        last_reservation = restaurant.last_reservation_time

        if cleaned_time > last_reservation and cleaned_time <= closing:
            self.add_error('time', 'Past last reservation time.')
        else:
